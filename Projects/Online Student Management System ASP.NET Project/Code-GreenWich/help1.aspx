...
<%@ Page language="c#" Inherits="e_learn.help1" CodeFile="help1.aspx.cs" %>
			...
			<table style="WIDTH: 100%; HEIGHT: 100%" align="left">
				<tr>
					<td style="WIDTH: 100%; HEIGHT: 100%" valign="top" align="left">
						<table style="WIDTH: 98.26%; HEIGHT: 91.59%" align="left">
							<tr>
								<td style="WIDTH: 100%; HEIGHT: 20%" align="left" colSpan="2">
									<P><uc1:banner id="Banner1" runat="server"></uc1:banner></P>
									<P><uc1:menus id="Menus1" runat="server"></uc1:menus></P>
								</td>
							</tr>
							<tr>
								<td style="WIDTH: 1.38%; HEIGHT: 100%" valign="top" align="left"></td>
								<td style="WIDTH: 100%; HEIGHT: 100%" valign="top" align="left">
									<table style="WIDTH: 100%; HEIGHT: 100%">
										<TBODY>
											<tr>
												<td style="HEIGHT: 54px" valign="top" align="left" colSpan="2">
													<p><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10px; COLOR: black; FONT-STYLE: normal; FONT-FAMILY: Verdana, Sans-Serif">Welcome 
															to Student's Sierra Optima Limited,Success of any company,inter alia,depends to 
															...
															topics,So for this traing the E-Learn site helps a lot to the Students </FONT>
													</p>
												</td>
											</tr>
											<tr>
												<td style="WIDTH: 30%; TEXT-ALIGN: justify" valign="top" align="center">
													<p><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10px; COLOR: black; FONT-STYLE: normal; FONT-FAMILY: Verdana, Sans-Serif">The 
															...
															<br>
														</FONT><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 16px; COLOR: navy; FONT-STYLE: normal; FONT-FAMILY: Verdana, Sans-Serif">
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<U>
																RULES TO LOGIN</U><br>
